...
import { Modal, ModalScrollBody } from "@/components/Modal";
import {
  useApplications,
  ...
  return (
    <div className="card" style={{ padding: 0, overflow: "hidden" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 14, padding: "14px 16px" }}>
        ...
        {/* Name + key — click name to open detail page */}
        ...
        {/* Actions — explicit manage button + delete */}
        <div style={{ display: "flex", alignItems: "center", gap: 8, flexShrink: 0 }}>
          <Link
            to="/applications/$appId"
            params={{ appId: app.id }}
            className="btn btn-ghost"
            style={{ padding: "5px 10px", fontSize: "0.75rem", display: "flex", alignItems: "center", gap: 6, textDecoration: "none" }}
          >
            <Settings size={13} />
            Manage
          </Link>
